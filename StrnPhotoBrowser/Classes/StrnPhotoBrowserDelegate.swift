//
//  StrnPhotoBrowserDelegate.swift
//  StrnPhotoBrowser
//
//
...
@objc public protocol StrnPhotoBrowserDelegate {
    ...
    /**
     ...
     - Parameter browser: reference to the calling StrnPhotoBrowser
     ...
     */
    @objc optional func removePhoto(_ browser: StrnPhotoBrowser, index: Int, reload: @escaping (() -> Void))
     ...
     */
    @objc optional func viewForPhoto(_ browser: StrnPhotoBrowser, index: Int) -> UIView?
