...
open class StrnCaptionView: UIView {
    fileprivate var photo: StrnPhotoProtocol?
    ...
    public convenience init(photo: StrnPhotoProtocol) {
...
private extension StrnCaptionView {
    func setup() {
        isOpaque = false
    ...
    func setupPhotoLabel() {
        ...
        photoLabel.font = StrnPhotoBrowserOptions.captionFont
